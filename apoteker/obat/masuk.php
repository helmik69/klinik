            ...
            <div class="content-body">
                <section class="app-user-list">
                    ...
                    <div class="container-fluid">
                        ...
                        <form method="get" action="../apoteker/index.php?page=masuk&dt=<?php echo $dt ?>&nama=<?php echo $nama ?>&no=<?php echo $penerima ?>">
                            <input type="hidden"  name="page" class="form-control"  value="masuk" />
                                ...
                                <div class="row pb-2 pt-1">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div>
                                            ...
                                            <a class="btn btn-success" href="download/masuk.php?dt=<?php echo $dt ?>&nama=<?php echo $nama ?>&no=<?php echo $penerima ?>"><i data-feather="save"></i> Download</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            <?php
                                ...
                                <table id="tbc" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th class="align-middle text-center col-sm-2">Penerima</th>
                                    ...
                                    <tbody>
                                        ...
                                        while (list( $id_masuk, $no_obat,  $stok, $created_at, $penerima, $bid, $idx, $nama, $harga, $bstok )=mysqli_fetch_array($tampil)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center"><a href="index.php?page=emasuk&id=<?php echo $id_masuk ?>" ><i class="fas fa-edit"></i> Edit</a></td>
											<td class="align-middle text-center"><a href="../apoteker/obat/delete.php?id=<?php echo $id_masuk ?>"  onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?')"><i class="fas fa-trash-alt"></i> Delete </a></td>
                    ...
                    <!-- list and filter end -->
                        ...
                        <div class="modal modal-slide-in new-user-modal fade" id="modals-slide-in">
                            <div class="modal-dialog">
                                <form class="add-new-user modal-content pt-0" action="../apoteker/obat/masuk_proses.php" method="POST">
                                    ...
                                    <div class="modal-body flex-grow-1">
                                        ...
                                        <div class="mb-1">
                                            <label class="form-label" for="penerima">Penerima</label>
                                            <input type="text" id="penerima" class="form-control dt-uname" placeholder="Penerima stok obat masuk" autocomplete="off" name="penerima"  />
                                        </div>
                                        <div class="mb-1">
                    ...
                    <!-- <?php
                        ...
                        // if($stok==!''){
                        // mysqli_query($conn, "INSERT INTO obat_masuk   (no_obat,penerima,stok) VALUES ('$no_obat','$penerima','$stok')") or die (mysqli_error($conn));
