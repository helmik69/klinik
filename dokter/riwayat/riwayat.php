...
$sql = "SELECT a.id, a.nik,a.id_dokter, a.created_at, a.anamnesa, a.diagnosa ,a.resep, b.id as bid, b.nama as pasien, b.nik as nikb, b.email, b.jk,b.no_hp, b.tempat_lahir, b.tanggal_lahir, b.alamat, b.jenis_pasien, b.no_bpjs,  c.id_dokter as idok, c.nama as nama_dokter, c.poli_id, c.start, c.off
        FROM rekam_medis a 
            ...
            <div class="content-body">
                <section class="app-user-list">
                    ...
                    <div class="container-fluid ">
                        ...
                        <form method="get" action="../dokter/index.php?page=riwayat&dt=<?php echo $dt ?>">
                            <input type="hidden"  name="page" class="form-control"  value="riwayat" />
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div>
                                            ...
                                            <a class="btn btn-success" href="download/rekam.php?dt=<?php echo $dt ?>&dokter=<?php echo $dokter ?>"  > <i data-feather="save"></i> Download</a>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3">
                                    </div>
                            ...
                            <?php
                                ...
                                <table id="tbc" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th class="align-middle text-center col-sm-2">Resep</th>
                                    ...
                                    <tbody>
                                        ...
                                        while (list($id, $nik,$id_dokter, $created_at, $anamnesa, $diagnosa ,$resep, $bid, $pasien, $nikb, $email, $jk,$no_hp, $tempat_lahir, $tanggal_lahir, $alamat, $jenis_pasien, $no_bpjs,  $idok, $nama_dokter, $spesialis, $start, $off)=mysqli_fetch_array($tampil)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center"><?php echo $resep ?></td>
