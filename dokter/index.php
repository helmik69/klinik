    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item" ><a class="nav-link d-flex align-items-center" href="index.php?page=berobat" ><i data-feather="calendar"></i><span data-i18n="Dashboards">Berobat</span></a>   
                    </li>
                    <li class="nav-item" ><a class="nav-link d-flex align-items-center" href="index.php?page=riwayat" ><i data-feather="calendar"></i><span data-i18n="Dashboards">Riwayat Rekam Medis</span></a>   
                    </li>
