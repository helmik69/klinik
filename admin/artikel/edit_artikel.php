...
$tampil=mysqli_query($conn,"SELECT * from artikel where id_artikel = '$id_artikel'") or die (mysqli_error($conn));
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <form method="post" action="../admin/artikel/update_artikel.php" enctype="multipart/form-data" >
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-2">
                                                    <label class="form-label" for="Judul">Judul</label>
                                                    <input type="text" id="blog-edit-title" class="form-control" name="judul" value="<?php echo $data['judul'] ?>"/>
                                                </div>
                                            </div>
                                                ...
                                                <div class="border rounded p-2">
                                                    ...
                                                    <div class="d-flex flex-column flex-md-row">
                                                        ...
                                                        <div class="featured-info">
                                                            ...
                                                            <input type="file" name="fileToUpload" class="form-control" value="<?php echo $data['img'] ?>">
                                                            </div>
