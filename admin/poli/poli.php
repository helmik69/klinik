            ...
            <div class="content-body">
                <section class="app-user-list">
                            ...
                            <?php
                                ...
                                <table id="tbc" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th class="align-middle text-center col-sm-2">Nama Poli</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center"><a href="index2.php?page=epoli&id=<?php echo $id ?>" ><i class="fas fa-edit"></i> Edit</a></td>
											<td class="align-middle text-center"><a href="../admin/poli/delete.php?id=<?php echo $id ?>"  onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?')"><i class="fas fa-trash-alt"></i> Delete </a></td>
                    ...
                    <?php
                        ...
                        mysqli_query($conn, "INSERT INTO poli    (nama) VALUES ('$nama')") or die (mysqli_error($conn));
                        
                        echo "<script>alert('Berhasil menambah data');window.location.href='index2.php?page=poli'</script>";  
                        }
