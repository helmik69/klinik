    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item" ><a class="nav-link d-flex align-items-center" href="index.php?page=pasien" ><i data-feather="clipboard"></i><span data-i18n="Dashboards">Laporan Data Pasien</span></a>   
                    </li>
                    
                <li class="nav-item" ><a class="nav-link d-flex align-items-center" href="index.php?page=rekam" ><i data-feather="activity"></i><span data-i18n="Dashboards">Laporan Rekam Medis</span></a>   
                    </li>
                <li class="nav-item" ><a class="nav-link d-flex align-items-center" href="index.php?page=pembayaran" ><i data-feather="airplay"></i><span data-i18n="Dashboards">Laporan Pembayaran</span></a>   
                    </li>
