...
$sheet->setCellValue('B3', "Tanggal Transaksi"); // Set kolom B3 dengan tulisan "NIS"
$sheet->setCellValue('C3', "Nama Obat"); // Set kolom C3 dengan tulisan "NAMA"
$sheet->setCellValue('D3', "Jumlah"); // Set kolom C3 dengan tulisan "NAMA"
$sheet->setCellValue('E3', "Harga"); // Set kolom C3 dengan tulisan "NAMA"
$sheet->setCellValue('F3', "Nama Admin"); // Set kolom C3 dengan tulisan "NAMA"
...
while (list( $id_pembayaran,$pasien, $no_obat, $admin, $jumlah, $created_at, $harga, $bid, $idx, $nama_obat, $harga_obat, $bstok  )=mysqli_fetch_array($tampil)) {
    ...
    $sheet->setCellValue('C' . $row, $nama_obat);
    $sheet->setCellValue('D' . $row, $jumlah);
    $sheet->setCellValue('E' . $row, $harga);
    $sheet->setCellValue('F' . $row, $admin);
