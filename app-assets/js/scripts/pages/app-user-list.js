...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: '../../../admin/staff/staff_list.php', // JSON file to add data
      columns: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="index.php?page=editstaff&id' +
              full['id'] +
              '" class="dropdown-item">' +
              feather.icons['file-text'].toSvg({ class: 'font-small-4 me-50' }) +
              'Details</a>' +
              '<a onclick="return confirm('+'Yakin ?'+')" href="/staff/hapus_staff.php?id' +
              full['id'] +
      ...
      buttons: [
        {
          ...
          text: feather.icons['external-link'].toSvg({ class: 'font-small-4 me-50' }) + 'Download',
          buttons: [
            {
              extend: 'print',
