            ...
            <div class="content-body">
                <section class="app-user-list">
                    ...
                    <div class="container-fluid ">
                        ...
                        <form method="get" action="../pasien/index.php?page=rekam&dt=<?php echo $dt ?>">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div>
                                            ...
                                            <a class="btn btn-success" href="download/rekam.php?dt=<?php echo $dt ?>&pasienx=<?php echo $pasienx ?>"  > <i data-feather="save"></i> Download</a>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3">
                                    </div>
