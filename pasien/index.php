            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <!-- <li class=" nav-item"><a class="d-flex align-items-center" href=""><i data-feather="users"></i><span class="menu-title text-truncate" data-i18n="Invoice">Data User</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="index2.php?page=staff"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Data Staff</span></a>
                        </li>
                ...
                <li class="nav-item" ><a class="nav-link d-flex align-items-center" href="index.php?page=pendaftaran" ><i data-feather="clipboard"></i><span data-i18n="Dashboards">Pendaftaran</span></a>   
                    </li>  
                <li class="nav-item" ><a class="nav-link d-flex align-items-center" href="index.php?page=riwayat" ><i data-feather="airplay"></i><span data-i18n="Dashboards">Riwayat Pendaftaran</span></a>   
                    </li> 
                <li class="nav-item" ><a class="nav-link d-flex align-items-center" href="index.php?page=rekam" ><i data-feather="cast"></i><span data-i18n="Dashboards">Rekam Medis</span></a>   
                    </li> 
        ...
        <?php
            $page = $_GET["page"];
                    if ($page == "home" || $page == "") {
                        ...
                        include "berobat/daftar_berobat.php";
                    }else if ($page == "detail") {
                        include "detail.php";
